...
# merge into template
decisions_csts_ms_ct <- dplyr::left_join(template_csts_ms_ct, decisions_csts_ms_ct, by = c("member_state", "year", "case_type", "decision_stage"))
...
# merge in decision stage data
decisions_csts_ms_ct <- dplyr::left_join(decisions_csts_ms_ct, decision_stages, by = "decision_stage")

# arrange
decisions_csts_ms_ct <- dplyr::arrange(decisions_csts_ms_ct, year, member_state_id, case_type_id, decision_stage_id)
...
# merge into template
decisions_csts_dp_ct <- dplyr::left_join(template_csts_dp_ct, decisions_csts_dp_ct, by = c("department", "year", "case_type", "decision_stage"))
...
# merge in decision stage data
decisions_csts_dp_ct <- dplyr::left_join(decisions_csts_dp_ct, decision_stages, by = "decision_stage")

# arrange
decisions_csts_dp_ct <- dplyr::arrange(decisions_csts_dp_ct, year, department_id, case_type_id, decision_stage_id)
