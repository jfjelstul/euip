...
# merge in department data
decisions_ddy_d <- dplyr::left_join(decisions_ddy_d, departments, by = "department")
...
# arrange
decisions_ddy_d <- dplyr::arrange(decisions_ddy_d, year, department_id, member_state_id, case_type_id, decision_stage_id)
