...
#' Query the EUIP Database API
#'
#' A function to query the EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
#'   exception of the `limit` and `offset` parameters, each parameter
#'   corresponds to a variable from the dataset. See the EUIP Database API
#'   Codebook for a list of valid parameters and the corresponding variable in
#'   the dataset, if applicable. See the EUIP Database Codebook for a
...
query_API <- function(parameters, route) {
  ...
  # API host
  host <- "https://www.api.eulaw.app/EUIP-database/"
...
#' Query the Cases Dataset of the EUIP Database
#'
#' A function to query the `EUIP_cases` dataset of the EUIP Database using the
#' EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
...
#'
#' @export
EUIP_cases_API <- function(parameters) {
...
#' Query the Parties Dataset of the EUIP Database
#'
#' A function to query the `cases_TS` and `cases_TS_D` datasets of the EUIP Database using the
#' EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
...
#'
#' @export
EUIP_cases_TS_API <- function(parameters) {
...
#' Query the Decisions Dataset of the EUIP Database
#'
#' A function to query the `cases_CSTS_MS`, `cases_CSTS_MS_D`, `cases_CSTS_DG`,
#' and `cases_CSTS_DG_D` datasets of the EUIP Database using the EUIP Database
#' API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
...
#'
#' @export
EUIP_cases_CSTS_API <- function(parameters) {
...
#' Query the Assignments Dataset of the EUIP Database
#'
#' A function to query the `cases_DDY`, `cases_DDY_D`, `cases_network`, and
#' `cases_network_D` datasets of the EUIP Database using the EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
#'   exception of the `limit` and `offset` parameters, each parameter
...
#'
#' @export
EUIP_cases_DDY_API <- function(parameters) {
...
#' Query the Cases Dataset of the EUIP Database
#'
#' A function to query the `EUIP_decisions` dataset of the EUIP Database using
#' the EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
#'   exception of the `limit` and `offset` parameters, each parameter
...
#'
#' @export
EUIP_decisions_API <- function(parameters) {
...
#' EUIP Database using the EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
#'   exception of the `limit` and `offset` parameters, each parameter
...
#'
#' @export
EUIP_decisions_TS_API <- function(parameters) {
...
#' `decisions_CSTS_DG`, and `decisions_CSTS_DG_D` datasets of the EUIP Database
#' using the EUIP Database API.
#'
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
#'   exception of the `limit` and `offset` parameters, each parameter
...
#'
#' @export
EUIP_decisions_CSTS_API <- function(parameters) {
...
#' `decisions_network`, and `decisions_network_D` datasets of the EUIP Database
#' using the EUIP Database API.
#' 
#' @param parameters A named list. The names of the elements of the list should
#'   correspond exactly to parameters of the EUIP Database API. With the
...
#'
#' @export
EUIP_decisions_DDY_API <- function(parameters) {
